...
def test_news_count(client, all_news, url_news_home):
...
def test_news_order(client, all_news, url_news_home):
    response = client.get(url_news_home)
    object_list = response.context['object_list']
...
def test_comments_order(client, url_news_detail, all_comments):
